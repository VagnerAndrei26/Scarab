...
/// @notice Support 18-decimal fixed point arithmetic. All Vault calculations use this for high and
/// uniform precision.
library FixedPoint {
  ...
  /**
   * @dev Returns x^y, assuming both are fixed point numbers, rounding up. The result is guaranteed
   * to not be below
   ...
   *
   * Useful when computing the complement for values with some level of relative error, as it strips
   * this error and
