...
contract MockRouterTest is Test {
  ...
  function setUp() public {
    ...
    // Mint reserve tokens
    rToken.mint(governance, 1_000_000_000_000_000_000_000_000);
    rToken.approve(address(poolFactory), 1_000_000_000_000_000_000_000_000);
  ...
  function testRouterCreate() public {
    ...
    usdc.mint(governance, 3_000_000_000_000_000_000_000);
    usdc.approve(address(mockRouter), 3_000_000_000_000_000_000_000);

    // Call create and assert minted tokens
    uint256 amount =
      mockRouter.swapCreate(address(pool), pool.couponToken(), Pool.TokenType.BOND, 3_000_000_000_000_000_000_000, 0);
    assertEq(amount, 31_250_000_000_000_000_000);
  }

  function testRouterRedeem() public {
    vm.startPrank(governance);

    pool.bondToken().approve(address(mockRouter), 31_000_000_000_000_000_000);

    // Call create and assert minted tokens
    uint256 amount =
      mockRouter.swapRedeem(address(pool), pool.couponToken(), Pool.TokenType.BOND, 31_000_000_000_000_000_000, 0);
    assertEq(amount, 2_976_000_000_000_000_000_000);
  }
