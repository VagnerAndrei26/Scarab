...
contract MockUniswapV3Pool {
  ...
  uint128 public liquidity = 9_169_178_941_640_739_570;
  ...
  function setStorage(uint160 _sqrtPriceX96) public {
    ...
    liquidity = 12_208_558_192_753_768_788;

    // Initialize slot0 variables with dummy data
    slot0 = Slot0({
      sqrtPriceX96: _sqrtPriceX96 == 0 ? 3_996_428_064_337_469_953_968_261 : _sqrtPriceX96,
      tick: -197_904,
      observationIndex: 0,
  ...
  /// @param _observationCardinalityNext The desired minimum number of observations for the pool to
  /// store
  ...
  {
    return (1_732_736_840_509_164, -173_273_684_050_916, 0, 0, 0, 0, 0, 0, 0, true);
  }
}
